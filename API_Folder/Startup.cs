...
namespace API_Folder
{
    public class Startup
    {
        public static string ConnectString { get; private set; }
        public static string ConnectStringWifi { get; private set; }
        private static List<ConfigQuanTracModel> _connectFolderQuanTrac = new List<ConfigQuanTracModel>();
        public static List<ConfigQuanTracModel> ConnectFolderQuanTrac { get => _connectFolderQuanTrac; private set => _connectFolderQuanTrac = value; }
        ...
        public Startup(IWebHostEnvironment env, IConfiguration configuration)
        {
            ...
            JToken filePathConnectionString = jAppSettings["FilePathConnectionString"];
            ConnectFolderQuanTrac = filePathConnectionString.ToObject<List<ConfigQuanTracModel>>();
        }
